...
class MentorizeNotification(models.Model):
    ...
    notif_type = fields.Selection([
        ...
        ('session_expired', 'Waktu Sesi Habis'),
        ('session_extension_requested', 'Pengajuan Tambah Waktu'),
        ('session_extension_approved', 'Tambah Waktu Disetujui'),
        ('session_extension_rejected', 'Tambah Waktu Ditolak'),
        ('chat', 'Chat'),
        ('report_new', 'Laporan Baru'),
        ('report_update', 'Update Laporan'),
        ('session_stop_requested', 'Pengajuan Berhenti'),
        ('session_stopped', 'Mentoring Dihentikan'),
